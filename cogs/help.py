...
class Help(commands.Cog):
    ...
    async def help(self, ctx, page: typing.Optional[str] = "0"):
        ...
        if page == "0":
            ...
            embed2.add_field(name="=======================", value="```p!tempmute [user] [time in minutes]``` - Temporary mutes's People!", inline=False)
            ...
            embed3.add_field(name="=======================", value="```p!tempban [user] [time] [reason - not required]``` - Temporary ban's People!", inline=False)
